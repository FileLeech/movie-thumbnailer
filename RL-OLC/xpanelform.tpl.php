...
<li class="ndot">
<input type="checkbox" id="act_rar" name="act_rar"<?php if($showpostn){if(isset($_POST['act_rar']) && $_POST['act_rar']=='on')echo ' checked';}elseif($disable_to["act_rar"]) echo ' checked'; ?>><label for=act_rar>&nbsp;Disable Rar</label></li>
<li class="ndot">
<input type="checkbox" id="act_unrar" name="act_unrar"<?php if($showpostn){if(isset($_POST['act_unrar']) && $_POST['act_unrar']=='on')echo ' checked';}elseif($disable_to["act_unrar"]) echo ' checked'; ?>><label for=act_unrar>&nbsp;Disable Unrar</label></li>
</div>
</td>
...
<tr>
<td class="tdacc"><label for="showmtn"><input type="checkbox" id="showmtn" name="showmtn" onClick="var displ=this.checked?'none':'';d.getElementById('mtnforbid').style.display=displ;d.getElementById('mtnforbidket').style.display=displ;"<?php if($showpostn){if(isset($_POST['showmtn']) && $_POST['showmtn']=='on')echo ' checked';}elseif($navi_left["showmtn"]) echo ' checked'; ?>>&nbsp;Show Movie Thumbnailer</label></td>
<td class="tdacc">Show Movie Thumbnailer Button <?php echo ($forbid_mtn? "<b class='r'>MTN DISABLED</b>":"");?></td>
</tr>
<tr>
<td class="tdacc" id="mtnforbid" style="display:<?php echo ($navi_left["showmtn"]?'none':'');?>">
<div style="padding-left:15px;">
<input type="checkbox" id="forbid_mtn" name="forbid_mtn"<?php if($showpostn){if(isset($_POST['forbid_mtn']) && $_POST['forbid_mtn']=='on')echo ' checked';}elseif($forbid_mtn) echo ' checked'; ?>><label for="forbid_mtn">&nbsp;*&nbsp;Forbidden to Movie Thumbnailer</label>
</div>
</td>
<td class="tdacc" id="mtnforbidket" style="display:<?php echo ($navi_left["showmtn"]?'none':'');?>">Restrict access to Movie Thumbnailer</td>
</tr>

<tr>
<td class="tdacc"><label for="shownotes"><input type="checkbox" id="shownotes" name="shownotes" onClick="var displ=this.checked?'none':'';d.getElementById('notesforbid').style.display=displ;d.getElementById('notesforbidket').style.display=displ;"<?php if($showpostn){if(isset($_POST['shownotes']) && $_POST['shownotes']=='on')echo ' checked';}elseif($navi_left["shownotes"]) echo ' checked'; ?>>&nbsp;Show Notes</label></td>
<td class="tdacc">Show Notes Button <?php echo ($forbid_notes? "<b class='r'>Notes DISABLED</b>":"");?></td>
</tr>
<tr>
<td class="tdacc" id="notesforbid" style="display:<?php echo ($navi_left["shownotes"]?'none':'');?>">
<div style="padding-left:15px;">
<input type="checkbox" id="forbid_notes" name="forbid_notes"<?php if($showpostn){if(isset($_POST['forbid_notes']) && $_POST['forbid_notes']=='on')echo ' checked';}elseif($forbid_notes) echo ' checked'; ?>><label for="forbid_notes">&nbsp;*&nbsp;Forbidden to Notes</label>
</div>
</td>
<td class="tdacc" id="notesforbidket" style="display:<?php echo ($navi_left["shownotes"]?'none':'');?>">Restrict access to Notes</td>
</tr>
...
<!-- ==========================START MTN-CONFIG -->
<!-- ==================================================-->
<tr class="tdacchead" id="trmtn" onclick="trclick(this);">
<td class="tdacc"><h1><span id="nod_trmtn"></span>MTN CONFIG</h1></td><td>&nbsp;</td>
</tr>

<tbody id="bd_trmtn" <?php echo (isset($_COOKIE["trmtn"])?($_COOKIE["trmtn"]==1?$styledisplay:''):$styledisplay);?>>

<tr>
<td class="tdacc"><input type="checkbox" id="showmtnconfig" name="showmtnconfig" onclick="var displ=this.checked?'':'none';document.getElementById('showmtn_text1').style.display=displ;document.getElementById('showmtn_text2').style.display=displ;"<?php if($showpostn){if(isset($_POST['showmtnconfig']) && $_POST['showmtnconfig']=='on')echo ' checked';}elseif($navi_left["showmtnconfig"]) echo ' checked'; ?>><label for="showmtnconfig">&nbsp;Show Config at MTN</label></td><td class="tdacc">Show Configuration at Movie Thumbnailer</td>
</tr>
<tr>
<td class="tdacc" id="showmtn_text1" style="display:<?php echo ($navi_left["showmtnconfig"]? '':'none');?>"><div style="padding-left:15px;"><input type="checkbox" id="showmtntext" name="showmtntext"<?php if($showpostn){if(isset($_POST['showmtntext']) && $_POST['showmtntext']=='on')echo ' checked';}elseif($showmtntext) echo ' checked'; ?>><label for="showmtntext">&nbsp;Show Text &amp; Output Suffix at MTN</label></div></td><td class="tdacc" id="showmtn_text2" style="display:<?php echo ($navi_left["showmtnconfig"]? '':'none');?>"> <div style="padding-left:15px;">Show Text &amp; Output Suffix at Movie Thumbnailer</div></td>
</tr>

<tr>
<td class="tdacc">&nbsp;&nbsp; Columns x Rows : </td><td class="tdacc"><select id="mtn_cs" name="mtn_cs"><option value="1"<?php echo ($mtn_cs == "1" ? ' selected="selected"':'');?>>1</option>
                                                                                                         ...
                                                                                                         <option value="5"<?php echo ($mtn_cs == "5" ? ' selected="selected"':'');?>>5</option></select> x <select id="mtn_rs" name="mtn_rs"><option value="1"<?php echo ($mtn_rs == "1" ? ' selected="selected"':'');?>>1</option>
...
<tr>
<td class="tdacc">&nbsp;&nbsp; Width :</td><td class="tdacc"><input type="text" id="mtn_w" name="mtn_w" size="3"  value="<?php echo $mtn_w; ?>" /></td>
</tr>

<tr>
<td class="tdacc">&nbsp;&nbsp; Minimum Height :</td><td class="tdacc"><input type="text" id="mtn_h" name="mtn_h" size="3"  value="<?php echo $mtn_h; ?>" /></td>
</tr>
               
<tr>
<td class="tdacc">&nbsp;&nbsp; Text :</td><td class="tdacc"><input type="text" id="mtn_T" name="mtn_T" size="25" value="<?php echo $mtn_T; ?>" /></td>                    
</tr>

<tr>
<td class="tdacc">&nbsp;&nbsp; Output Suffix :</td><td class="tdacc"><input type="text" id="mtn_o" name="mtn_o" size="25" value="<?php echo $mtn_o; ?>" /></td>                    
</tr>
               
<tr>
<td class="tdacc">&nbsp;&nbsp; Background Color :</td><td class="tdacc"><select id="mtn_k" name="mtn_k"><option value="000000"<?php echo ($mtn_k == "000000" ? ' selected="selected"':'');?>>Black</option>
...
<tr><td class="tdacc">&nbsp;&nbsp; Jpeg Quality :</td><td class="tdacc"><select id="mtn_j" name="mtn_j"><option value="80"<?php echo ($mtn_j == "80" ? ' selected="selected"':'');?>>Low</option>
...
<tr>
<td class="tdacc">&nbsp;&nbsp; Edge :</td><td class="tdacc"><select id="mtn_g" name="mtn_g"><option value="0"<?php echo ($mtn_g == "0" ? ' selected="selected"':'');?>>Off</option>
...
<tr>
<td class="tdacc">&nbsp;&nbsp; Individual Shots :</td><td class="tdacc"><input type="checkbox" id="mtn_I" name="mtn_I" value="-I"<?php echo ($mtn_I == "-I" ? ' checked="checked"':'');?> />On</td>
</tr>

<tr>
<td class="tdacc">&nbsp;&nbsp; Video Info :</td><td class="tdacc"><input type="checkbox" id="mtn_i"  name="mtn_i" value="true"<?php echo ($mtn_i == "true" ? ' checked="checked"':'');?> />On &nbsp; <select id="mtn_Ts" name="mtn_Ts"><option value="8"<?php echo ($mtn_Ts == "8" ? ' selected="selected"':'');?>>8</option>
                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                       <option value="15"<?php echo ($mtn_Ts == "15" ? ' selected="selected"':'');?>>15</option></select> Size &nbsp; <select id="mtn_Tc" name="mtn_Tc"><option value="000000"<?php echo ($mtn_Tc == "000000" ? ' selected="selected"':'');?>>Black</option>
                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                        <option value="FFFFFF"<?php echo ($mtn_Tc == "FFFFFF" ? ' selected="selected"':'');?>>White</option></select> Color &nbsp; <select id="mtn_f" name="mtn_f"><option value="blue.ttf"<?php echo ($mtn_f == "blue.ttf" ?  ' selected="selected"':'');?>>Blue</option>
...
<tr>
<td class="tdacc">&nbsp;&nbsp; Time :</td><td class="tdacc"><input type="checkbox" id="mtn_t" name="mtn_t" value="true"<?php echo ($mtn_t == "true" ? ' checked="checked"':'');?> />On &nbsp; <select id="mtn_tc" name="mtn_tc"><option value="000000"<?php echo ($mtn_tc == "000000" ? ' selected="selected"':'');?>>Black</option>
                                                                                                                                                                                                                                <option value="000099"<?php echo ($mtn_tc == "000099" ? ' selected="selected"':'');?>>Blue</option>
                                                                                                                                                                                                                                <option value="006600"<?php echo ($mtn_tc == "006600" ? ' selected="selected"':'');?>>Green</option>
                                                                                                                                                                                                                                <option value="CC0000"<?php echo ($mtn_tc == "CC0000" ? ' selected="selected"':'');?>>Red</option>
                                                                                                                                                                                                                                <option value="FFFF00"<?php echo ($mtn_tc == "FFFF00" ? ' selected="selected"':'');?>>Yellow</option>
                                                                                                                                                                                                                                <option value="FFFFFF"<?php echo ($mtn_tc == "FFFFFF" ? ' selected="selected"':'');?>>White</option></select> Color &nbsp; <select id="mtn_ts" name="mtn_ts"><option value="000000"<?php echo ($mtn_ts == "000000" ? ' selected="selected"':'');?>>Black</option>
...
<tr>
<td class="tdacc">&nbsp;&nbsp; Location :</td><td class="tdacc"><select id="mtn_iL" name="mtn_iL"><option value="1"<?php echo ($mtn_iL == "1" ? ' selected="selected"':'');?>>Lower Left</option>
                                                                                                  <option value="4"<?php echo ($mtn_iL == "4" ? ' selected="selected"':'');?>>Upper Left</option></select> Info &nbsp; <select id="mtn_tL" name="mtn_tL"><option value="1"<?php echo ($mtn_tL == "1" ? ' selected="selected"':'');?>>Lower Left</option>
...
<script type="text/javascript">
var trtab = Array('limit','files','view','misc','mtn');
