...
?>
<a href="lynx.php" target="_blank"><img src="<?php echo IMAGE_DIR.'listedfile.gif'?>" alt="List Files"></a><br />
<?php
}
if($navi_left["showmtn"]){
?>
<a href="mtn.php" target="_blank"><img src="<?php echo IMAGE_DIR.'mtn.png'?>" alt="Movie Thumbnailer"></a><br />
<?php
}
if($navi_left["shownotes"]){
?>
[ <a href="#" onclick="window.open('notes.php', 'Servecom', 'scrollbars=1, width=700, height=450, resizable=1');return false;">Notes.txt</a> ]
<?php
}
?>
