...
foreach ($video as $vdo)
{
	...
	$cmd.=" -c ".$c." -r ".$r." -h ".$mtn_h." -T '".$mtn_T."' -o '".$mtn_o.".jpg' -k ".$mtn_k." -j ".$mtn_j." -g ".$mtn_g." '".$mtn_I."' -F '".$mtn_Tc.":".$mtn_Ts.":'mtn/".$mtn_f."':".$mtn_tc.":".$mtn_ts.":".$mtn_Ts."' -f 'mtn/".$mtn_f."' -b 0.60 -B 0.0 -C 6000 -D 8 -L '".$mtn_iL.":".$mtn_tL."' -E 0.0 '".getcwd()."/$download_dir/".$vdo."'";
	shell_exec($cmd);
