...
if(isset($_POST['submit'])){
	...
	*/
	...
	$field = array("act_upload", "act_ftp", "act_mail", "act_boxes", "act_split", "act_merge", "act_md5", "act_pack", "act_zip", "act_unzip", "act_rename", "act_mrename", "act_delete", "act_rar", "act_unrar");
	...
	$_config .= "\$mtn_I = '".$_POST['mtn_I']."';\n";
	$_config .= "\$mtn_i = '".$_POST['mtn_i']."';\n";
	$_config .= "\$mtn_Ts = '".$_POST['mtn_Ts']."';\n";
	$_config .= "\$mtn_Tc = '".$_POST['mtn_Tc']."';\n";
	$_config .= "\$mtn_f = '".$_POST['mtn_f']."';\n";
	$_config .= "\$mtn_t = '".$_POST['mtn_t']."';\n";
	$_config .= "\$mtn_tc = '".$_POST['mtn_tc']."';\n";
	$_config .= "\$mtn_ts = '".$_POST['mtn_ts']."';\n";
	$_config .= "\$mtn_iL = '".$_POST['mtn_iL']."';\n";
	$_config .= "\$mtn_tL = '".$_POST['mtn_tL']."';\n\n";
